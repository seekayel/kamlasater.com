...
<main class="page-content" aria-label="Content">
  ...
  <div class="wrapper"><div class="container intro-container">
    ...
    <p>In professional life that means software and software companies. In personal
      life that means I am a husband, father of four boys and gardener outside of
      Philadelphia PA. Mornings you can find me running, lifting or rolling bjj.</p>
    <br>
  </div>
  ...
  <div class="container experience-container">
    ...
    <div>
      <h3>Cyclic (<a href="//www.cyclic.sh" target="_blank" class="link">www.cyclic.sh</a>)</h3>
    ...
    <div>
      <h3>Black Knight Financial Services (<a href="//bkfs.com" target="_blank" class="link">bkfs.com</a>)</h3>
    ...
    <div>
      ...
      <ul>
        ...
        <li>Managed AWS infrastructure and security</li>
...
<br>
  ...
  <div class="container footer-container">
    <p>Kam Lasater - <a href="mailto:ckl@seekayel.com" target="_blank">ckl@seekayel.com</a></p>
  </div>
